  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        mnemonic: "🧠 'FRSAN HC' = 7 Protected Classes",
        facts: [
          "F – Familial status (families with children under 18)",
          "R – Race",
          "S – Sex",
          "A – Age... wait, NOT age! Replace with: A = (not a class)",
          "N – National origin",
          "H – Handicap (disability)",
          "C – Color",
          "Religion also protected",
          "DOES NOT include: marital status, sexual orientation (federally)",
    ...
    items: [
      {
        ...
        facts: [
          ...
          "Freddie Mac nickname: 'Freddie' or FHLMC",
        ],
      },
      {
        title: "FHA Loans",
        ...
        facts: [
          ...
          "Max DTI: 43% typically (can go higher with compensating factors)",
      ...
      },
      {
        ...
        facts: [
          ...
          "Entitlement: Basic $36,000 / bonus up to county limit",
      ...
      },
      {
        ...
        facts: [
          "Also called: Rural Development or Section 502",
          "Down payment: 0%",
    ...
    items: [
      {
        ...
        facts: [
          ...
          "Some add 5th C: Conditions (loan terms, market, purpose)",
      ...
      },
      {
        ...
        facts: [
          ...
          "FHA: 31% front / 43% back (guideline, flexible with compensating factors)",
      ...
      },
      {
        ...
        facts: [
          ...
          "Self-employed: 2 years tax returns, net income + add-backs ÷ 24",
          "Part-time: 2-year history typically required",
          "Commission: 2-year average of 1040 + employer verification",
      ...
      },
      {
        ...
        facts: [
          ...
          "HCLTV = Highest CLTV (includes HELOCs at max draw)",
    ...
    items: [
      {
        ...
        facts: [
          "HOEPA High Cost: APR > 6.5% above APOR (1st lien) OR > 8.5% (2nd lien)",
          "HOEPA Points & Fees: > 5% of loan (or $1,192 if loan < $24,866 — 2024)",
          "ATR/QM: Applies to loans $100,000+ typically",
          "HMDA asset threshold: $54 million",
          "RESPA Section 10 escrow cushion: 2 months max",
          "PMI auto-cancel: 78% LTV (22% equity)",
          "Section 32 (HOEPA) counseling: Required before closing",
        ],
      },
      {
        ...
        facts: [
          ...
          "Safe Harbor: Rebuttable presumption for higher-priced QMs",
        ],
      },
      {
        ...
        facts: [
          ...
          "CFPB: Consolidates consumer protection from 7 agencies",
          "Volcker Rule: Banks cannot do proprietary trading",
      ...
      },
      {
        ...
        facts: [
          "Gramm-Leach-Bliley (GLB): Requires privacy notice to customers",
          "Privacy notice: Annual requirement from financial institutions",
          "Right to opt out: Of sharing with non-affiliated third parties",
          "Red Flags Rule: FTC rule to detect identity theft (must have program)",
          "FACTA: Consumers can get free annual credit report",
          "Safeguards Rule: Must protect customer financial information",
    ...
    items: [
      {
        ...
        facts: [
          "Index: Benchmark rate (SOFR, CMT, MTA) — the base",
          "Margin: Lender's profit added to index (fixed throughout loan)",
          "Fully Indexed Rate = Index + Margin",
          "Initial cap: First adjustment limit (e.g., 2% = 2/2/5 ARM)",
          "Periodic cap: Each adjustment limit (middle number)",
          "Lifetime cap: Total adjustment from start rate (last number)",
          "2/2/5 ARM: First adjust max 2%, each adjust max 2%, lifetime max 5%",
          "Teaser rate: Below-market initial rate (common in ARMs)",
        ],
      },
      {
        ...
        facts: [
          ...
          "Option ARM: Choose payment type (minimum, interest-only, fully amortizing)",
          "Balloon: Large final payment (e.g., 5/25 = 5-year balloon, 25-yr amortization)",
          "Prepayment penalty: Hard = any prepay; Soft = only refinance",
          "Interest-only: Pay only interest for set period, then fully amortize",
          "GPM: Graduated payment mortgage — payments start low, increase",
          "Buydown: 3-2-1 buydown = rate reduced 3%, 2%, 1% for first 3 years",
        ],
      },
      {
        ...
        facts: [
          ...
          "Draw period: Typically 10 years (interest only option)",
          "Repayment period: Typically 20 years (fully amortizing)",
          "Home Equity Loan: Fixed lump sum (closed-end second)",
          "Subordination: 2nd lien subordinate to 1st lien",
          "Piggyback: 80/10/10 = 80% 1st, 10% 2nd, 10% down (avoids PMI)",
          "80/15/5 = 80% 1st, 15% 2nd, 5% down",
        ],
      },
      {
        ...
        facts: [
          ...
          "Interest accrues onto loan balance",
          ...
          "Max loan: Based on age, rates, and home value (lesser of appraised or FHA limit)",
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        facts: [
          ...
          "Title search: Examines public records for defects",
          ...
          "Abstract of title: Summary of all recorded documents",
          "Attorney opinion letter: Alternative to title insurance in some states",
        ],
      },
      {
        title: "Deed Types",
        ...
        facts: [
          "General Warranty Deed: Grantor warrants title against ALL claims (most protection)",
          "Special Warranty Deed: Warrants only claims arising DURING grantor's ownership",
          "Bargain and Sale Deed: No warranties (common in foreclosures)",
          "Quitclaim Deed: No warranties at all — conveys whatever interest grantor has",
          "Deed of Trust: 3 parties (trustor, trustee, beneficiary) — used instead of mortgage",
          "Reconveyance Deed: Returns title after loan paid off (deed of trust states)",
        ],
      },
      {
        ...
        facts: [
          ...
          "Escrow analysis: Annual review; max $50 overage returned",
          "Origination charges: Zero tolerance (cannot increase)",
          "Transfer taxes: State/county taxes on property transfer",
          "Recording fees: Zero tolerance (cannot change)",
          "Proration: Dividing ongoing costs between buyer/seller",
          "HUD/Settlement statement (now Closing Disclosure): Itemizes all costs",
        ],
      },
    ],
  },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(ellipse at center, #4a9eff11 0%, transparent 70%)",
          pointerEvents: "none",
        }} />
              ...
              <div key={section.id} style={{ marginBottom: "12px" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: activeSection === section.id
                      ? `linear-gradient(135deg, ${section.color}, #0a0a0f)`
                      : "#111118",
                ...
                >
                  ...
                  <span style={{
                    ...
                    fontWeight: "700",
                    letterSpacing: "-0.5px",
                    color: activeSection === section.id ? section.accent : "#ddd",
                  }}>
                    {section.title}
                  </span>
                  <span style={{
        ...
        {activeTab === "flashcards" && (
          <div>
            <div style={{
              ...
              <h2 style={{ margin: 0, fontSize: "20px", color: "#ccc" }}>
                ⚡ Quick-Fire Facts ({quickFacts.length} total)
              </h2>
              ...
              {quickFacts.map((fact, idx) => (
                ...
                >
                  ...
                  <div style={{
                    ...
                    borderRadius: "4px",
                    padding: revealed[idx] ? "0" : "2px 8px",
                    transition: "all 0.2s",
                    minHeight: "24px",
                  }}>
            ...
            <div style={{ marginTop: "40px" }}>
              <h2 style={{ color: "#ff7a4a", fontSize: "18px", marginBottom: "16px" }}>
              ...
              <div style={{
                ...
                {[
                  ...
                  ["3 years", "Extended right of rescission (no disclosure)"],
                  ["2%", "HECM upfront MIP"],
                ].map(([num, desc], i) => (
                  <div key={i} style={{
                    display: "flex",
            ...
            <div style={{
              marginTop: "32px",
              background: "linear-gradient(135deg, #1a1a2e, #0f1a0f)",
              border: "1px solid #4aff8a44",
              borderRadius: "12px",
              padding: "24px",
            }}>
              <h2 style={{ color: "#4aff8a", margin: "0 0 16px", fontSize: "18px" }}>
                💡 Last-Minute Strategy Tips
              </h2>
              {[
                "🎯 TRID: 3-3-7 = LE in 3 days, CD 3 days before closing, borrower has 7 biz days to review",
                "🎯 When in doubt: FHA = HUD, VA = VA, USDA = Agriculture",
                "🎯 ECOA vs Fair Housing: ECOA = credit decisions; FHA = property transactions",
                "🎯 Loan Processor does NOT need license UNLESS they exercise independent judgment",
                "🎯 Zero tolerance = origination charges. Cannot increase. Ever.",
                "🎯 Right of rescission = REFINANCE only, not purchase. 3 days.",
                "🎯 Steering = illegal. Redlining = illegal. Blockbusting = illegal.",
                "🎯 MLO compensation cannot be based on loan terms (interest rate, type, etc.)",
                "🎯 QM = safe harbor but not immunity. ATR must ALWAYS be verified.",
              ].map((tip, i) => (
                <div key={i} style={{
                  padding: "8px 0",
                  borderBottom: i < 8 ? "1px solid #1a2a1a" : "none",
                  fontSize: "14px",
                  color: "#ccc",
                  lineHeight: "1.6",
                }}>
